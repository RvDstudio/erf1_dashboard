...
import OrderDetailsClient from '@/app/dashboard/order_history/[id]/OrderDetailsClient';
...
export default async function OrderDetails({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="p-6">
      ...
      {/* Pass the orderId and totalPrice to the client component */}
      <OrderDetailsClient orderId={id} totalPrice={order.total_price} status={order.status} />
    </div>
  );
}
