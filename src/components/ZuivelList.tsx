// Path: src\components\ZuivelList.tsx
'use client';
...
export default function ZuivelList({ zuivel }: ZuivelListProps) {
  ...
  useEffect(() => {
    const total = zuivel.reduce((total, product) => {
  ...
  }, [orderData.selectedProducts, quantities, supabase, router]);
